...
def fakeEmail():
  faker = Faker()
  print ('')
  print ('             \033[1;37m[ Tool Random Email ]')
  print ('')
  data_kytu = ['', '_', '.']
  so_luong = int(input(" \033[1;37m➩ Nhập Số Lượng : "))
  Domain = input(" \033[1;37m➩ Nhập Domain(ex: yahoo) : ")
  file_email = input(" \033[1;37m➩ Nhập File Lưu Mails(ex: email.txt) : ")
  n = 0
  for fake in range(so_luong):
    ...
    print (" [" + str(n) + "]\033[1;37m~" + fake_email)
...
def checkhotmail():
  print ('')
  print ('             \033[1;37m[ Tool Check Hotmail ]')
  print ('')
  try:
    print (" \033[1;37m~CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
    hotmail = open(input(" \033[1;37m ~Nhập File Chứa Hotmail(ex: hotmail.txt) : ")).readlines()
    hotmail_die = input(" \033[1;37m ~Nhập File Lưu Hotmail Die(hotmaildie.txt) : ")
    hotmail_live = input(" \033[1;37m~Nhập File Lưu Hotmail Live(hotmaillive.txt) : ")
  except:
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print ("\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  print ("")
  print ("             \033[1;37m[ Tool Check Yahoo ]")
  print ("")
  try:
    print (" \033[1;37m~CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
    n_yahoo = 0
    yahoo = open(input(" \033[1;37m~Nhập File Chứa Yahoo(ex: yahoo.txt) : ")).readlines()
    yahoo_die = input(" \033[1;37m~Nhập File Lưu Yahoo Die(ex: yahoodie.txt) : ")
    yahoo_live = input(" \033[1;37m~Nhập File Lưu Yahoo Live(ex: yahoolive.txt) : ")
  except:
    print (" \033[1;37mKHÔNG TÌM THẤY FILE BẠN ĐÃ NHẬP !")
    quit()
  list_yid = []
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m~[●] |Email Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m~[●] |Email Live| " + yid + "@yahoo.com")
...
def checkvalid():
  print ('')
  print ('             \033[1;37m[ Tool Facebook ]')
  print ('')
  try:
    print (" \033[1;37m~ LƯU Ý :")
    print ("   \033[1;37m•KHÔNG HỖ TRỢ ĐỊNH DẠNG MAIL|PASS")
    print ("   \033[1;37m•TOOL CHẠY ĐA LUỒNG ĐỒNG NGHĨA VỚI IP CỦA BẠN SẼ DỄ BỊ FB BLOCK HƠN")
    print ("   \033[1;37m•VUI LÒNG FAKE IP TRƯỚC CHẠY TOOL NÀY")
    print ("   \033[1;37m•mỖI IP CHECK ĐƯỢC 50-80 MAIL RỒI ĐỔI IP KHÁC")
    fileEmail = open(input(" \033[1;37m ~Nhập File Chứa Email(ex: email.txt) : ")).readlines()
    valid = input(" \033[1;37m ~Nhập File Lưu Email Valid Facebook(ex: validfb.txt) : ")
  except:
    print (" \033[1;37mKHÔNG TÌM THẤY FILE BẠN ĐÃ NHẬP !")
    quit()
  list_email_fb = []
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print (" \033[1;35m~[●]\033[1;32m| Có Liên Kết |" + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print (" \033[1;35m~[●]\033[1;31m| Không Liên Kết |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
\033[1;37m     
               ...
               \033[1;36m Copyright By : Aftab khan
               \033[1;36m Facebook : https://www.facebook.com/bilal.walana.7
"""
...
def process_menu():
  menu = """  
           \033[1;33m      ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
                 \033[1;33m┃ ➩ Nhập [1] Tool random mail  ┃
                 \033[1;33m┃ ➩ Nhập [2] Tool check hotmail┃
                 \033[1;33m┃ ➩ Nhập [3] Tool check yahoo  ┃
                 \033[1;33m┃ ➩ Nhập [4] Tool check Valid  ┃
                 \033[1;33m┃ ➩ Nhập [5] Tool random ny(sắp ra mắt)┃
                 \033[1;33m┃ ➩ Nhập [6] Thoát Tool        ┃
           \033[1;33m      ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
...
"""
  for letter in menu:
  	...
  	sys.stdout.flush()
  	time.sleep(0.001)
  choice_user = input("\033[1;37m~[●] ➩ Mày thích chạy số mấy,chọn nhanh lên: ")
  if choice_user == '1':
    clear()
    fakeEmail()
  if choice_user == '2':
